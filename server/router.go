...
func InitRouter(r *gin.Engine) {
	...
	publicApiRouter := r.Group("/douyin")
	{
		...
		publicApiRouter.GET("/favorite/list/", api.FavoriteList)
		publicApiRouter.POST("/comment/action/", api.CommentAction)
		publicApiRouter.GET("/comment/list/", api.CommentList)
		publicApiRouter.POST("/relation/action/", api.RelationAction)
		publicApiRouter.GET("/relation/follow/list/", api.FollowList)
		publicApiRouter.GET("/relation/follower/list/", api.FollowerList)
